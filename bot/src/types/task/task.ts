...
export interface InteractionTaskParameters extends BaseTaskOptions {
  type: 'use' | 'place' | 'break';
  target: string;
  item?: string;
}

export interface HealingTaskParameters extends BaseTaskOptions {
  type: 'food' | 'potion';
  item?: string;
  threshold?: number;
}

export interface UnknownTaskParameters extends BaseTaskOptions {
  action: string;
  parameters: Record<string, any>;
}
...
export type TaskParameters =
  ...
  | CraftingTaskParameters
  | InteractionTaskParameters
  | HealingTaskParameters
