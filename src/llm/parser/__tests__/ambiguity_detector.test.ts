...
describe('AmbiguityDetector', () => {
  ...
  describe('detectAmbiguity', () => {
    it('should detect unambiguous mining command', async () => {
      const result = await detector.detectAmbiguity('mine diamond ore', mockContext);
    ...
    it('should detect unambiguous crafting command', async () => {
      const result = await detector.detectAmbiguity('craft wooden pickaxe', mockContext);
    ...
    it('should detect unambiguous navigation command', async () => {
      const result = await detector.detectAmbiguity('go to 100 64 -200', mockContext);
    ...
    it('should detect ambiguous command with multiple matches', async () => {
      const result = await detector.detectAmbiguity('go to village', mockContext);
    ...
    it('should consider context factors in scoring', async () => {
      ...
      (mockContext.worldState.nearbyBlocks as any) = [
        { type: 'diamond_ore' }
      ];
